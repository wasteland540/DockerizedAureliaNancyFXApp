define('app',['exports', './web-api'], function (exports, _webApi) {
  ...
  var App = exports.App = function () {
    ...
    App.prototype.configureRouter = function configureRouter(config, router) {
      ...
      config.map([{ route: '', moduleId: './components/no-selection/no-selection', title: 'Select' }, { route: 'contacts/:id', moduleId: './components/contact-detail/contact-detail', name: 'contacts' }]);
...
define('messages',["exports"], function (exports) {
    ...
    var ContactAdded = exports.ContactAdded = function ContactAdded(contact) {
        _classCallCheck(this, ContactAdded);
...
define('components/contact-detail/contact-detail',['exports', 'aurelia-event-aggregator', '../../web-api', '../../messages', '../../utility'], function (exports, _aureliaEventAggregator, _webApi, _messages, _utility) {
    'use strict';
    ...
    var ContactDetail = exports.ContactDetail = (_temp = _class = function () {
        ...
        ContactDetail.prototype.setContactAndTitle = function setContactAndTitle(contact) {};
...
define('components/contact-dialog/contact-dialog',['exports', 'aurelia-dialog'], function (exports, _aureliaDialog) {
    'use strict';

    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    exports.ContactDialog = undefined;
    ...
    var ContactDialog = exports.ContactDialog = (_temp = _class = function ContactDialog(controller) {
...
define('components/contact-list/contact-list',['exports', 'aurelia-event-aggregator', 'aurelia-http-client', 'aurelia-dialog', '../../web-api', '../../messages', '../contact-dialog/contact-dialog'], function (exports, _aureliaEventAggregator, _aureliaHttpClient, _aureliaDialog, _webApi, _messages, _contactDialog) {
    'use strict';
    ...
    var ContactList = exports.ContactList = (_temp = _class = function () {
        function ContactList(api, ea, dialogService) {
            var _this = this;
            ...
            this.ea.subscribe(_messages.ContactAdded, function (msg) {
        ...
        ContactList.prototype.openDialog = function openDialog() {
            var _this3 = this;

            this.dialogService.open({ viewModel: _contactDialog.ContactDialog, model: {} }).then(function (response) {
                if (!response.wasCancelled) {
                    _this3.api.saveContact(response.output).then(function (contact) {
                        _this3.contact = contact;
                        _this3.originalContact = JSON.parse(JSON.stringify(contact));

                        _this3.ea.publish(new _messages.ContactAdded(_this3.contact));
                    });
                } else {
                    console.log('bad');
                }
        ...
        return ContactList;
    }(), _class.inject = [_webApi.WebAPI, _aureliaEventAggregator.EventAggregator, _aureliaDialog.DialogService], _temp);
});
...
define('text!components/contact-dialog/contact-dialog.html', ['module'], function(module) { module.exports = "<template><ai-dialog><ai-dialog-header>Create New Contact</ai-dialog-header><ai-dialog-body><div class=\"row\"><label class=\"col-sm-2 control-label\">First Name</label><div class=\"col-sm-10\"><input type=\"text\" placeholder=\"first name\" class=\"form-control\" value.bind=\"contact.firstName\"></div></div><div class=\"row\"><label class=\"col-sm-2 control-label\">Last Name</label><div class=\"col-sm-10\"><input type=\"text\" placeholder=\"last name\" class=\"form-control\" value.bind=\"contact.lastName\"></div></div><div class=\"row\"><label class=\"col-sm-2 control-label\">Email</label><div class=\"col-sm-10\"><input type=\"text\" placeholder=\"email\" class=\"form-control\" value.bind=\"contact.email\"></div></div><div class=\"row\"><label class=\"col-sm-2 control-label\">Phone</label><div class=\"col-sm-10\"><input type=\"text\" placeholder=\"phone\" class=\"form-control\" value.bind=\"contact.phoneNumber\"></div></div></ai-dialog-body><ai-dialog-footer><button click.trigger=\"controller.cancel()\">Cancel</button> <button click.trigger=\"controller.ok(contact)\">Ok</button></ai-dialog-footer></ai-dialog></template>"; });
define('text!components/contact-list/contact-list.html', ['module'], function(module) { module.exports = "<template><div class=\"contact-list\"><ul class=\"list-group\"><li repeat.for=\"contact of contacts\" class=\"list-group-item ${contact.id === $parent.selectedId ? 'active' : ''}\"><a route-href=\"route: contacts; params.bind: {id:contact.id}\" click.delegate=\"$parent.select(contact)\"><h4 class=\"list-group-item-heading\">${contact.firstName} ${contact.lastName}</h4><p class=\"list-group-item-text\">${contact.email}</p></a></li></ul><div class=\"button-bar\"><button class=\"btn btn-success\" click.delegate=\"openDialog()\">New</button> <button class=\"btn btn-success\" click.delegate=\"callNancy()\" disabled=\"disabled\">Call API</button></div></div></template>"; });
